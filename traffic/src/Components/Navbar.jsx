...
Navbar.propTypes = {
 ...
 navTextStyle: PropTypes.object,
 navIcon: PropTypes.object,
 navBGColor: PropTypes.string,
 navCartIcon: PropTypes.string,
 navSearchIcon: PropTypes.string,
};

// Props are passed as parameters
export default function Navbar({navPosition, navTextStyle, navBGColor,  navSearchIcon}){
    ...
    <div className='navbar-container' style={navPosition}>
      ...
      <div className='nav-center'>
        <div className='nav-text' style={navStyle}>
          <button className='logo' onClick={navigateToHome}>HOME</button>
        </div>
      </div>
